...
class CreaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create creature" do
    assert_difference("Creature.count") do
      post creatures_url, params: { creature: { description: @creature.description, name: @creature.name, picture: @creature.picture, power: @creature.power } }
    end
  ...
  test "should update creature" do
    patch creature_url(@creature), params: { creature: { description: @creature.description, name: @creature.name, picture: @creature.picture, power: @creature.power } }
